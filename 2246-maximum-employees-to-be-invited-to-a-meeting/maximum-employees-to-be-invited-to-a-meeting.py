class Solution:
                ...
                while True:
                    ...
                    if next_person in visited_persons:
                        ...
                        if cycle_length == 2:
                            ...
                            two_cycle_invitations += (2 + self._bfs(next_person, visited_nodes, reversed_graph) + self._bfs(current_person, visited_nodes, reversed_graph) )
                            break
    ...
    def _bfs(self, start_node, visited_nodes, reversed_graph):
